...
import com.dataapplab.mybatis.model.AccountExample.Criteria;
import com.dataapplab.mybatis.model.AccountExample.Criterion;
...
public class AccountSqlProvider {
    ...
    public String insertSelective(Account record) {
        ...
        if (record.getResetToken() != null) {
            sql.VALUES("reset_token", "#{resetToken,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getResetToken() != null) {
            sql.SET("reset_token = #{record.resetToken,jdbcType=VARCHAR}");
        }
