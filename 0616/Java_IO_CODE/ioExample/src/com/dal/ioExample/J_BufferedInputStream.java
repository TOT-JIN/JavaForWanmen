...
public class J_BufferedInputStream{
	public static void main(String[] args){
		...
		try{
			f=new BufferedInputStream(new FileInputStream("F:\\BaiduYunDownload\\eclipse-jee-kepler-SR1-win32-x86_64\\eclipse\\workspace\\ioExample\\src\\com\\dal\\ioExample\\test.txt"));
			while((ch=f.read())!=-1){
				i++;
			}	
			f.close();
